...
const Orders = () => {
    const [orders, setOrders] = useState([
        { id: '#ORD-001', customer: 'Juan Pérez', date: '2023-10-25', total: 125.00, status: 'Pendiente' },
        { id: '#ORD-002', customer: 'Maria Garcia', date: '2023-10-24', total: 45.00, status: 'Pagado' },
        { id: '#ORD-003', customer: 'Carlos Lopez', date: '2023-10-24', total: 200.00, status: 'Enviado' },
    ]);
